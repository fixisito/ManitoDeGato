...
namespace ManitoDeGato
{
    public partial class FormPrincipal : Form
    {
        ...
        private void btnServicios_Click(object sender, EventArgs e)       => AbrirFormularioHijo(new FormServicios(),     sender);
        private void btnEstilistas_Click(object sender, EventArgs e)      => AbrirFormularioHijo(new FormEstilistas(),    sender);
        private void btnAgendamientos_Click(object sender, EventArgs e)   => AbrirFormularioHijo(new FormAgendamientos(), sender);
        private void btnProductos_Click(object sender, EventArgs e)       => AbrirFormularioHijo(new FormProductos(),     sender);
    }
}
